...
// Consultar todos os veterinários cadastrados
try {
    $mongoManager = new MongoDBManager('mongo', '27017', 'PetSeguro');
    $veterinariosCollection = $mongoManager->getCollection('veterinarios');

    // Consulta todos os veterinários
    $veterinariosCursor = $veterinariosCollection->find();
} catch (Exception $e) {
...
<nav class="navbar navbar-expand-lg navbar-light navbar-custom">
    ...
    <section class="gerenciar-veterinarios-section" id="gerenciar-veterinarios">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="text-center">Gerenciar Veterinários</h1>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php foreach ($veterinariosCursor as $veterinario) : ?>
                                <tr>
        ...
        <button class="btn btn-primary" type="button" onclick="window.location.href='cadastro_vet.html'">Cadastrar Novo Veterinário</button>
    </section>
